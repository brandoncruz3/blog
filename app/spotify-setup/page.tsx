      ...
      <div className="container py-12">
        <div className="mx-auto max-w-2xl">
          <div className="prose dark:prose-dark max-w-none">
            ...
            <p>
              Make sure your <code>.env</code> file has your real Spotify Client ID:
            </p>
            <div className="rounded-lg bg-gray-100 p-4 font-mono text-sm dark:bg-gray-800">
              SPOTIFY_CLIENT_ID="your_real_client_id_here"
              <br />
            ...
            <p>
              Click the button below to start the PKCE authentication flow. After successful
              authentication, you'll get a refresh token to add to your .env file.
            </p>
            ...
            <ul>
              <li>
                <strong>More Secure:</strong> No client secret needed on the client side
              </li>
              <li>
                <strong>Modern Standard:</strong> Recommended by OAuth 2.1 specification
              </li>
              <li>
                <strong>Better UX:</strong> Streamlined authentication process
              </li>
              <li>
                <strong>Mobile Friendly:</strong> Works well with mobile apps and SPAs
              </li>
            </ul>
